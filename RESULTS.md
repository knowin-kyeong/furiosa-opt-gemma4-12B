...
| `V187_overhead_probes` | `V182` | **탐침 4종(중복 실행, PASS-safe).** a1 attn_out contraction store 1회 추가(정적 +2,510) · a2 staged x2 복제 로드 1회 추가(정적 +0) · q1 qkv RoPE cos/sin HBM 왕복 1회 추가(정적 +4,551) · f1 ffn down store 1회 추가(정적 +2,510). 증분 = 그 연산의 실물 비용 | 49,343 (q1) | 30,683 (a1) / 28,173 (a2) | 143,884 (f1) | — | 큐 ×2 | — | 어떤 오버헤드가 실물에서 비싼지 가려서 V189~V192를 고른다 |
