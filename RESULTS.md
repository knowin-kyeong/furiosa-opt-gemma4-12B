...
| `V197_segment_curve` | `V194` | 고정 3.93 MB를 7,680 / 3,840 / 1,920 / 960 / 480 / 240 / 120 B 런으로, 정렬·비정렬 두 기준점에서 추가 로드해 **비용 = f(런 길이, 정렬)** 곡선을 실측한다. book의 "256 B 정렬 위반 시 읽기 2×"와 V174의 2.13×를 하나의 모델로 고정 | — | — | — | — | 설계됨 | — | **설계됨** — 보고서 §10 열린 질문 1(290 B/cycle 벽의 정체)에 대한 직접 답 |
...
| `V202_ffn_down_2_chunks` | `V194` | V183의 레이아웃을 **교란 요인 둘 없이** 재구성: ring-32 x broadcast 없음, 새 f32 hop 없음. 레이아웃과 구현을 분리한다(보고서 §10 열린 질문 4) | — | — | — | — | 설계됨 | — | **설계됨** |
