...
| `V193_final_candidate` | `V182` | **최종 후보**: 채점 커널에 q4+q6(qkv)와 44/16(attn_out)을 모두 적용하고, **V182의 옛 모양을 같은 잡의 변형(`old`, `t48`)으로 유지**해 잡간 cold 분산(±5k) 없이 한 잡 안에서 A/B | **43,920** | **28,301** | 141,374 | — | job 15741/15742/15743 (변형당 n=3): **qkv 새 105,101 / 104,163 / 103,251 vs old 108,736 / 107,944 / 108,114 → 세 잡 모두 −3.6k~−4.9k (평균 −4.09k)**; **attn 새 55,013 / 51,685 / 54,950 vs t48 55,918 / 52,674 / 55,492 → 세 잡 모두 −0.5k~−1.0k (평균 −0.81k)**; ffn 317,780 / 311,856 / 315,066 | 전부 **PASS** | **확정** — 잡간 분산(±5k)을 제거하고도 두 변경 모두 3/3 잡에서 이긴다. qkv −3.8%, attn_out −1.5% |
| `V194_production` | `V182` | **프로덕션(변형 없음)** = V182 + q4 + q6 + 44/16. 제출 형태 | **43,920** | **28,301** | 141,374 | — | 큐 ×3 cold | — | V193의 잡 내 델타를 V165 공식 draw에 적용하면 **예상 공식 ≈ 6.06** (V165 5.7576 대비 +5.3%) |
