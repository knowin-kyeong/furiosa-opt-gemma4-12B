...
| 커널 | 같은 코드의 실측 | 편차 |
|---|---|---:|
| qkv (V50 / V82 / V138의 V50 부분) | 159,405 · 149,244 · 136,576 | **±8%** |
| attn_out (V82 vs V138, 코드 동일) | 56,586 · 52,244 | **±4%** |
| ffn (V50 두 번) | 354,825 · 353,981 | 0.2% |
...
실측 136,576 / 56,586 / 351,454, 3/3 PASS. ffn이 V50의 354,825 → 351,454(−0.95%)로 makespan
예측(−419, −0.26%)과 방향이 같다. qkv·attn_out 차이는 위 노이즈 범위 안이므로 증거로 치지 않는다.
기준 (b)를 만족하므로 채택한다.
