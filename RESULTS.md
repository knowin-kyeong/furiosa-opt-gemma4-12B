...
| `V193_final_candidate` | `V182` | **최종 후보**: 채점 커널에 q4+q6(qkv)와 44/16(attn_out)을 모두 적용하고, **V182의 옛 모양을 같은 잡의 변형(`old`, `t48`)으로 유지**해 잡간 cold 분산(±5k) 없이 한 잡 안에서 A/B | **43,920** | **28,301** | 141,374 | — | 큐 ×3 | — | 잡 내 비교로 q4+q6와 44/16의 순효과를 확정한다 |
