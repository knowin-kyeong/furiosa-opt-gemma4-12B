...
| `V230_begin_interleaved` | `V228` | 저장소가 한 번도 쓴 적 없는 API. book: "combines two tensors with **identical mappings** into a single sequencer operation… at most two". ffn up+gate pass A와 qkv K+V가 그 형태 | — | — | — | — | — | — | **설계됨** |
