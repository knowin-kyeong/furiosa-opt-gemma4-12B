...
pub fn sliding_project_qkv_q2(
    ...
    let (q, k) = sliding::rope::apply_rope_heads_q2::<layout::HeadClusters, layout::HeadSlicesPerCluster>(
        ctx,
        &q,
        &k,
        rope_offset,
...
pub fn sliding_project_qkv_q3(
    ...
    let (q, k) = sliding::rope::apply_rope_heads_q3::<layout::HeadClusters, layout::HeadSlicesPerCluster>(
        ctx,
        &q,
        &k,
        rope_offset,
...
pub fn sliding_project_qkv_q4(
    ...
    let (q, k) = sliding::rope::apply_rope_heads_q4::<layout::HeadClusters, layout::HeadSlicesPerCluster>(
        ctx,
        &q,
        &k,
        rope_offset,
