...
pub fn sliding_project_qkv(
    ...
    // 8 real copies, each read by a different eighth of the slices (V51/V52: the copy count
    ...
    let x: DmTensor<f8e4m3, Chip, layout::BothClusters, m![Dummy256 / 32, Dummy256 % 32], m![Dummy2, H]> =
