...
/// V215 probe p1: one extra 15.73 MB query-weight load, one 30,720-byte run per slice.
#[device(chip = 1)]
pub fn sliding_project_qkv_p1(
    ...
    sliding::projection::probe_q_block(ctx, q_weight);
    let q_weight = sliding::projection::load_query_weight(ctx, q_weight);
...
/// V215 probe p4: one extra 15.73 MB query-weight load, four 7,680-byte runs per slice.
#[device(chip = 1)]
pub fn sliding_project_qkv_p4(
    ...
    sliding::projection::probe_q_cyclic_4(ctx, q_weight);
    let q_weight = sliding::projection::load_query_weight(ctx, q_weight);
...
/// V215 probe p8: one extra 15.73 MB query-weight load, eight 3,840-byte runs per slice.
#[device(chip = 1)]
pub fn sliding_project_qkv_p8(
    ...
    sliding::projection::probe_q_cyclic_8(ctx, q_weight);
    let q_weight = sliding::projection::load_query_weight(ctx, q_weight);
