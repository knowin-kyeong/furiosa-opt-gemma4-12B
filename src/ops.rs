...
pub fn sliding_project_qkv(
    ...
    // 2 real copies, each read by a different half of the slices (V51/V52: the copy count
    ...
    let x: DmTensor<f8e4m3, Chip, layout::BothClusters, m![Dummy256 / 128, Dummy256 % 128], m![Dummy2, H]> =
