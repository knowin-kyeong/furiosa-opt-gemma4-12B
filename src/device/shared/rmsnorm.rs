...
/// V390b `c3`: `normalize_add_gate_reduced_t1` over the sum of two partial rows, the second in a register.
pub(crate) fn normalize_add_gate_reduced_t1_c3<Cluster: M>(
    ctx: &mut Context,
    x: &DmTensor<bf16, Chip, Cluster, ReducingSlices, m![H % 480]>,
    x1: &DmTensor<bf16, Chip, Cluster, ReducingSlices, m![H % 480]>,
    g: &DmTensor<f32, Chip, Cluster, ReducingSlices, m![1 # 8]>,
