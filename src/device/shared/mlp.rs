...
up_gate_reduce_fns!(reduce_up_gate_rows_4, 4);
...
pub(crate) fn feedforward(
    ...
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 0, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 0, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 4, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 4, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 8, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 8, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 12, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 12, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 16, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 16, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 20, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 20, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 24, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 24, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 28, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 28, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 32, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 32, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 36, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 36, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 40, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 40, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 44, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 44, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 48, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 48, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 52, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 52, &mut gate);
    reduce_up_gate_rows_4(ctx, &up_partials, &up_scale, 56, &mut up);
    reduce_up_gate_rows_4(ctx, &gate_partials, &gate_scale, 56, &mut gate);
