...
pub(crate) fn feedforward(
    ...
    reduce_up_gate_rows_8(ctx, &up_partials, &up_scale, 0, &mut up);
    reduce_up_gate_rows_8(ctx, &gate_partials, &gate_scale, 0, &mut gate);
    reduce_up_gate_rows_8(ctx, &up_partials, &up_scale, 8, &mut up);
    reduce_up_gate_rows_8(ctx, &gate_partials, &gate_scale, 8, &mut gate);
    reduce_up_gate_rows_8(ctx, &up_partials, &up_scale, 16, &mut up);
    reduce_up_gate_rows_8(ctx, &gate_partials, &gate_scale, 16, &mut gate);
    reduce_up_gate_rows_8(ctx, &up_partials, &up_scale, 24, &mut up);
    reduce_up_gate_rows_8(ctx, &gate_partials, &gate_scale, 24, &mut gate);
    reduce_up_gate_rows_8(ctx, &up_partials, &up_scale, 32, &mut up);
    reduce_up_gate_rows_8(ctx, &gate_partials, &gate_scale, 32, &mut gate);
    reduce_up_gate_rows_8(ctx, &up_partials, &up_scale, 40, &mut up);
    reduce_up_gate_rows_8(ctx, &gate_partials, &gate_scale, 40, &mut gate);
    reduce_up_gate_rows_8(ctx, &up_partials, &up_scale, 48, &mut up);
    reduce_up_gate_rows_8(ctx, &gate_partials, &gate_scale, 48, &mut gate);
