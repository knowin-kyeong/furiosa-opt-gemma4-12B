...
up_gate_reduce_fns!(reduce_up_gate_rows_30, 30);
...
pub(crate) fn feedforward(
    ...
    reduce_up_gate_rows_30(ctx, &up_partials, &up_scale, 0, &mut up);
    reduce_up_gate_rows_30(ctx, &gate_partials, &gate_scale, 0, &mut gate);
    reduce_up_gate_rows_30(ctx, &up_partials, &up_scale, 30, &mut up);
    reduce_up_gate_rows_30(ctx, &gate_partials, &gate_scale, 30, &mut gate);
