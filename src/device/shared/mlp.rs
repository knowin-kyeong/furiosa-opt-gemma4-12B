...
pub(crate) fn feedforward(
    ...
    let down0 = load_down_rows_60(ctx, down_weight_packed, 0);
    ...
    let p = contract_down_rows_60(ctx, &x_trf, &down0);
    reduce_down_rows_60(ctx, &p, &down_scale, &inv_s_vrf, 0, &mut down);
...
down_tile_fns!(load_down_rows_60, contract_down_rows_60, reduce_down_rows_60, 60);
