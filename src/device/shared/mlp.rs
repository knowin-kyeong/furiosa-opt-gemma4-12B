...
pub(crate) fn stage_x_hi_lo_hbm(
    ...
    // Eight real copies, one store per copy (a copy axis alone replicates nothing, V50).
...
fn stage_geglu_hi_lo_hbm(
    ...
    // Eight real copies of every chunk, one store per copy.
...
pub(crate) fn feedforward(
    ...
    // half spread over the eight copies.
