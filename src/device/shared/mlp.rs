...
pub(crate) fn feedforward(
    ...
    reduce_up_gate_rows_8(ctx, &up_partials, &up_scale, 28, &mut up);
    reduce_up_gate_rows_8(ctx, &gate_partials, &gate_scale, 28, &mut gate);
    reduce_up_gate_rows_8(ctx, &up_partials, &up_scale, 36, &mut up);
    reduce_up_gate_rows_8(ctx, &gate_partials, &gate_scale, 36, &mut gate);
    reduce_up_gate_rows_8(ctx, &up_partials, &up_scale, 44, &mut up);
    reduce_up_gate_rows_8(ctx, &gate_partials, &gate_scale, 44, &mut gate);
