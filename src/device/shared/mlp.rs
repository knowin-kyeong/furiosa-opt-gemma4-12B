...
pub(crate) fn feedforward(
    ...
    let p = contract_down_rows_40(ctx, &x_trf, &down0);
    reduce_down_rows_40(ctx, &p, &down_scale, &inv_s_vrf, 0, &mut down);
...
down_tile_fns!(load_down_rows_40, contract_down_rows_40, reduce_down_rows_40, 40);
