...
pub(crate) fn feedforward(
    ...
    let p = contract_down_rows_48(ctx, &x_trf, &down0);
    reduce_down_rows_48(ctx, &p, &down_scale, &inv_s_vrf, 0, &mut down);
...
down_tile_fns!(load_down_rows_48, contract_down_rows_48, reduce_down_rows_48, 48);
