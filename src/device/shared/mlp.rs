...
up_gate_reduce_fns!(reduce_up_gate_rows_60, 60);
...
pub(crate) fn feedforward(
    ...
    reduce_up_gate_rows_60(ctx, &up_partials, &up_scale, 0, &mut up);
    reduce_up_gate_rows_60(ctx, &gate_partials, &gate_scale, 0, &mut gate);
