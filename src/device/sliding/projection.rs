...
pub(crate) fn project_output(
    ...
    ctx.main
        ...
        .commit_view(contraction.view_mut().tile::<m![H % 60], 20, m![H % 60 = 20 #{!} 60]>(0));
    ctx.main
        .begin(tile1.view())
        .fetch::<m![H % 60 = 20, Qs / 64 % 8, Dummy2], m![Qs % 64]>()
        .collect::<m![H % 60 = 20, Qs / 64 % 8, Dummy2, Qs / 32 % 2], m![Qs % 32]>()
        ...
        .transpose::<m![H % 60 = 20 / 4], m![H % 60 = 20 % 4 # 16]>()
        .commit_trim::<m![H % 60 = 20 % 4]>()
        .commit_view(contraction.view_mut().tile::<m![H % 60], 20, m![H % 60 = 20 #{!} 60]>(20));
    ctx.main
        .begin(tile2.view())
        ...
        .commit_view(contraction.view_mut().tile::<m![H % 60], 12, m![H % 60 = 12 #{!} 60]>(40));
    ctx.main
        .begin(tile3.view())
