...
pub(crate) fn project_output(
    ...
    // Eight HBM copies of the pieces (the `Dummy8` axis, absent from the source, replicates
    // the store at no extra descriptor cost): the 64 readers of each chunk are spread over the
