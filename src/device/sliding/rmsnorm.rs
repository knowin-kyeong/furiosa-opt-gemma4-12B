...
/// V355: `normalize_query_heads` with its bf16 casts in the Commit Adapter (`commit_cast`).
pub(crate) fn normalize_query_heads_cc<C: M, S: M>(
    ctx: &mut Context,
    x: &DmTensor<bf16, Chip, C, S, m![Gs, Ds]>,
    channel_scale: &HbmTensor<bf16, Chip, m![Qs]>,
    rms_weight: &HbmTensor<bf16, Chip, m![Ds]>,
...
/// V355: `normalize_key_heads` with its bf16 casts in the Commit Adapter (`commit_cast`).
pub(crate) fn normalize_key_heads_cc<C: M, S: M>(
    ctx: &mut Context,
    x: &DmTensor<bf16, Chip, C, S, m![Ds]>,
    channel_scale: &HbmTensor<bf16, Chip, m![Ps]>,
    rms_weight: &HbmTensor<bf16, Chip, m![Ds]>,
...
/// V355: `normalize_value_heads` with its bf16 casts in the Commit Adapter (`commit_cast`).
pub(crate) fn normalize_value_heads_cc<C: M, S: M>(
    ctx: &mut Context,
    x: &DmTensor<bf16, Chip, C, S, m![Ds]>,
    channel_scale: &HbmTensor<bf16, Chip, m![Ps]>,
) -> DmTensor<bf16, Chip, C, S, m![Ds]> {
