...
/// V316: rotate_half and the sin multiply fused into two half passes per tensor.
pub(crate) fn apply_rope_heads_rf<C: M, S: M>(
    ctx: &mut Context,
    q: &DmTensor<bf16, Chip, C, S, m![Gs, Ds]>,
    k: &DmTensor<bf16, Chip, C, S, m![Ds]>,
    rope_offset: &HbmTensor<i32, Chip, m![1]>,
    ...
    // V316: the sin row as two half VRFs; each multiplies the opposite half of q or k.
