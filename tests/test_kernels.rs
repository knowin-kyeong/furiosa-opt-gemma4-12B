...
const TESTS: &[Test] = &[
    ...
    t("sliding_project_qkv", "", 0.04),
    t("sliding_project_qkv", "v155a", 0.04),
    t("sliding_project_qkv", "v155a", 0.04),
    t("sliding_project_qkv", "v155g", 0.04),
    t("sliding_project_qkv", "v155g", 0.04),
    t("sliding_project_qkv", "v155e", 0.04),
    t("sliding_project_qkv", "v155e", 0.04),
    t("sliding_project_qkv", "v155d", 0.04),
    t("sliding_project_qkv", "v155d", 0.04),
...
async fn sliding_project_qkv(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "v155a" => launch(ops::sliding_project_qkv_v155a, (
                ctx,
                &x,
                &q_weight,
                &k_weight,
        ...
        "v155g" => launch(ops::sliding_project_qkv_v155g, (
                ctx,
                &x,
                &q_weight,
                &k_weight,
        ...
        "v155e" => launch(ops::sliding_project_qkv_v155e, (
                ctx,
                &x,
                &q_weight,
                &k_weight,
        ...
        "v155d" => launch(ops::sliding_project_qkv_v155d, (
                ctx,
                &x,
                &q_weight,
                &k_weight,
