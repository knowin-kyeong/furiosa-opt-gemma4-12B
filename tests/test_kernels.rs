...
const TESTS: &[Test] = &[
    ...
    t("sliding_project_qkv", "q2", 0.04),
    t("sliding_project_qkv", "q3", 0.04),
    t("sliding_project_qkv", "q4", 0.04),
    t("sliding_project_qkv", "", 0.04),
    t("sliding_project_qkv", "q2", 0.04),
    t("sliding_project_qkv", "q3", 0.04),
    t("sliding_project_qkv", "q4", 0.04),
...
async fn sliding_project_qkv(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "q2" => launch(ops::sliding_project_qkv_q2, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
        ...
        "q3" => launch(ops::sliding_project_qkv_q3, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
        ...
        "q4" => launch(ops::sliding_project_qkv_q4, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
