...
const TESTS: &[Test] = &[
    ...
    t("sliding_attention_output", "x1", 0.05),
    t("sliding_attention_output", "x2", 0.05),
    t("sliding_attention_output", "", 0.05),
    t("sliding_attention_output", "x1", 0.05),
    t("sliding_attention_output", "x2", 0.05),
    t("sliding_attention_output", "", 0.05),
...
async fn sliding_attention_output(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "x1" => launch(ops::sliding_attention_output_x1, (
            ctx,
            &x,
        ...
        "x2" => launch(ops::sliding_attention_output_x2, (
            ctx,
            &x,
            &post_attn_rms_weight,
            &o_weight,
