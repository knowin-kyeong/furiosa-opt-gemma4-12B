...
const TESTS: &[Test] = &[
    ...
    t("sliding_attention_output", "p0", 0.05),
    t("sliding_attention_output", "p1", 0.05),
    t("sliding_attention_output", "", 0.05),
    t("sliding_attention_output", "p0", 0.05),
    t("sliding_attention_output", "p1", 0.05),
    t("sliding_attention_output", "", 0.05),
...
async fn sliding_attention_output(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "p0" => launch(ops::sliding_attention_output_p0, (
            ctx,
            &x,
        ...
        "p1" => launch(ops::sliding_attention_output_p1, (
            ctx,
            &x,
            &post_attn_rms_weight,
            &o_weight,
