...
async fn sliding_project_qkv(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "r16" => launch(ops::sliding_project_qkv_r16, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
        ...
        "r8" => launch(ops::sliding_project_qkv_r8, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
        ...
        "r4" => launch(ops::sliding_project_qkv_r4, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
...
async fn decoder_feedforward(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "r16" => launch(ops::decoder_feedforward_r16, (
            ctx,
            &mut residual,
            &pre_ff_rms_weight,
            &up_weight_packed,
        ...
        "r4" => launch(ops::decoder_feedforward_r4, (
            ctx,
            &mut residual,
            &pre_ff_rms_weight,
            &up_weight_packed,
