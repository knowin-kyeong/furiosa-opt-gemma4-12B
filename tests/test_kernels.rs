...
const TESTS: &[Test] = &[
    ...
    t("decoder_feedforward", "d1", 0.01),
    t("decoder_feedforward", "d2", 0.01),
    t("decoder_feedforward", "d3", 0.01),
    t("decoder_feedforward", "", 0.01),
    t("decoder_feedforward", "d1", 0.01),
    t("decoder_feedforward", "d2", 0.01),
    t("decoder_feedforward", "d3", 0.01),
...
async fn decoder_feedforward(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "d1" => launch(ops::decoder_feedforward_d1, (
            ctx,
            &mut residual,
            &pre_ff_rms_weight,
            &up_weight_packed,
        ...
        "d2" => launch(ops::decoder_feedforward_d2, (
            ctx,
            &mut residual,
            &pre_ff_rms_weight,
            &up_weight_packed,
        ...
        "d3" => launch(ops::decoder_feedforward_d3, (
            ctx,
            &mut residual,
            &pre_ff_rms_weight,
            &up_weight_packed,
