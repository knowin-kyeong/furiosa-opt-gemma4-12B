...
const TESTS: &[Test] = &[
    ...
    t("sliding_attention_output", "a1", 0.05),
    t("sliding_attention_output", "a2", 0.05),
    t("sliding_attention_output", "", 0.05),
    t("sliding_attention_output", "a1", 0.05),
    t("sliding_attention_output", "a2", 0.05),
    t("sliding_attention_output", "", 0.05),
    ...
    t("sliding_project_qkv", "q1", 0.04),
    t("sliding_project_qkv", "", 0.04),
    t("sliding_project_qkv", "q1", 0.04),
    t("decoder_feedforward", "", 0.01),
    t("decoder_feedforward", "f1", 0.01),
];
...
async fn sliding_project_qkv(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "q1" => launch(ops::sliding_project_qkv_q1, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
...
async fn sliding_attention_output(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "a1" => launch(ops::sliding_attention_output_a1, (
            ctx,
            &x,
        ...
        "a2" => launch(ops::sliding_attention_output_a2, (
            ctx,
            &x,
            &post_attn_rms_weight,
            &o_weight,
...
async fn decoder_feedforward(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "f1" => launch(ops::decoder_feedforward_f1, (
            ctx,
            &mut residual,
            &pre_ff_rms_weight,
            &up_weight_packed,
