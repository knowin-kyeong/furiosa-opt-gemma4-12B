...
const ATTN_SWEEP: &[&str] = &["v7", "ut", "ut", "v7", "v7", "ut", "ut", "v7", "v7", "ut", "ut", "v7", "v7", "ut", "ut", "v7"];
...
async fn sliding_attention_output(
    ...
    for (i, variant) in plan.order.iter().enumerate() {
        ...
        match *variant {
            ...
            "ut" => {
                launch(
                    ops::sliding_attention_output_ut,
                    (
                        ctx,
                        &x,
                        &post_attn_rms_weight,
            ...
            "ua" => {
                launch(
                    ops::sliding_attention_output_ua,
                    (
                        ctx,
                        &x,
                        &post_attn_rms_weight,
            ...
            "ub" => {
                launch(
                    ops::sliding_attention_output_ub,
                    (
                        ctx,
                        &x,
                        &post_attn_rms_weight,
            ...
            "v7" => {
                launch(
                    ops::sliding_attention_output_v7,
                    (
                        ctx,
                        &x,
                        &post_attn_rms_weight,
