...
const TESTS: &[Test] = &[
    // V219: N minimal vector passes chained head to tail, results discarded. The slope is
    // the real cost of one pass. i8 runs the same eight with no dependency between them.
    t("sliding_project_qkv", "n0", 0.04),
    t("sliding_project_qkv", "n4", 0.04),
    t("sliding_project_qkv", "n8", 0.04),
    t("sliding_project_qkv", "n16", 0.04),
    t("sliding_project_qkv", "i8", 0.04),
    t("sliding_project_qkv", "n0", 0.04),
    t("sliding_project_qkv", "n4", 0.04),
    t("sliding_project_qkv", "n8", 0.04),
    t("sliding_project_qkv", "n16", 0.04),
...
async fn sliding_project_qkv(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        "n0" => launch(ops::sliding_project_qkv_n0, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
        ...
        "n4" => launch(ops::sliding_project_qkv_n4, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
        ...
        "n8" => launch(ops::sliding_project_qkv_n8, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
        ...
        "n16" => launch(ops::sliding_project_qkv_n16, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
        ...
        "i8" => launch(ops::sliding_project_qkv_i8, (
            ctx,
            &x,
            &q_weight,
            &k_weight,
