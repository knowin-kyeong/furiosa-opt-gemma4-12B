...
const TESTS: &[Test] = &[
    ...
    t("sliding_attention_output", "t56", 0.05),
    t("sliding_attention_output", "t52", 0.05),
    t("sliding_attention_output", "t44", 0.05),
    t("sliding_attention_output", "t40", 0.05),
    t("sliding_attention_output", "", 0.05),
    t("sliding_attention_output", "t60", 0.05),
    t("sliding_attention_output", "t56", 0.05),
    t("sliding_attention_output", "t52", 0.05),
...
async fn sliding_attention_output(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "t56" => launch(ops::sliding_attention_output_t56, (
            ctx,
            &x,
            &post_attn_rms_weight,
            &o_weight,
        ...
        "t52" => launch(ops::sliding_attention_output_t52, (
            ctx,
            &x,
            &post_attn_rms_weight,
            &o_weight,
        ...
        "t44" => launch(ops::sliding_attention_output_t44, (
            ctx,
            &x,
            &post_attn_rms_weight,
            &o_weight,
        ...
        "t40" => launch(ops::sliding_attention_output_t40, (
            ctx,
            &x,
            &post_attn_rms_weight,
            &o_weight,
