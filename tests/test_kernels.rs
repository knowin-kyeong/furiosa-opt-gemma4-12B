...
const TESTS: &[Test] = &[
    ...
    t("sliding_attention_output", "c128", 0.05),
    t("sliding_attention_output", "c256", 0.05),
    t("sliding_attention_output", "c1024", 0.05),
    t("sliding_attention_output", "c2048", 0.05),
    t("sliding_attention_output", "", 0.05),
    t("sliding_attention_output", "c128", 0.05),
    t("sliding_attention_output", "c256", 0.05),
    t("sliding_attention_output", "c1024", 0.05),
...
async fn sliding_attention_output(ctx: &mut Context, fixture: &Fixture, variant: &str) -> Vec<(&'static str, Vec<f32>)> {
    ...
    match variant {
        ...
        "c128" => launch(ops::sliding_attention_output_c128, (
            ctx,
            &x,
        ...
        "c256" => launch(ops::sliding_attention_output_c256, (
            ctx,
            &x,
            &post_attn_rms_weight,
            &o_weight,
        ...
        "c1024" => launch(ops::sliding_attention_output_c1024, (
            ctx,
            &x,
            &post_attn_rms_weight,
            &o_weight,
        ...
        "c2048" => launch(ops::sliding_attention_output_c2048, (
            ctx,
            &x,
            &post_attn_rms_weight,
            &o_weight,
